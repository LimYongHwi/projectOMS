...
public class Service_Center_Controller {
	...
	public void modifyFormService(Model model, int num, @RequestParam(defaultValue = "1") int page,
			@RequestParam(required = false) String keyword, @RequestParam(defaultValue = "0") int type,
			HttpSession session) {

		// model.addAttribute("Service_Center",
		// SCservice.selectAllService(params, page));
	...
	public String modifyService(HttpSession session, Service_CenterVO SC, @RequestParam(defaultValue = "1") int page,
			@RequestParam(required = false) String keyword, @RequestParam(defaultValue = "0") int type) {
	...
	@RequestMapping(value = "getFAQList.do", method=RequestMethod.POST,produces="application/json;charset=UTF-8")
	@ResponseBody
	public void getFAQList(@RequestParam(defaultValue = "1") int page, int tab_no,
			HttpServletResponse resp) {
		HashMap<String, Object> params = new HashMap<String, Object>();
		params.put("FAQ_TAB", tab_no);
		HashMap<String, Object> resultMap = new HashMap<String, Object>();
		JSONObject job=new JSONObject();
		resultMap = SCservice.getFAQList(params, page);
		job.put("result",resultMap);
